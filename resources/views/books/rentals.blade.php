      ...
      <div class="flex justify-between">
        <a class="flex items-center space-x-4" href="{{ route('detail', ['id' => $rental->stockBook->stock_book_id]) }}">
          <div class="flex-shrink-0">
              ...
              @else
                <lottie-player src="{{ asset('https://book-mamagement-system.vercel.app/animations/no_book.json') }}" background="transparent" speed="1" style="width: 100px; height: 100px;" loop autoplay></lottie-player>
              @endif
          </div>
