<x-index-layout>
  <div class="flex flex-col sm:flex-row justify-between">
    <div class="col ml-4 mb-6">
      ...
      @else
        <lottie-player src="{{ asset('https://book-mamagement-system.vercel.app/animations/no_book.json') }}" background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay></lottie-player>
      @endif
            ...
            <div class="relative w-full max-w-sm max-h-full mx-auto">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="flex">
                      ...
                      <lottie-player src="{{ asset('https://book-mamagement-system.vercel.app/animations/dog_walk.json') }}" background="transparent" speed="1" style="width: 200px; height: 200px;" loop autoplay class="-ml-8 -mr-2"></lottie-player>
                    </div>
      ...
      <div class=" block bg-gray-400 shadow p-6 rounded-2xl scrollbar-hide border-2 border-slate-500/30" style="overflow-y: auto; height:400px; min-width:350px; max-width: 450px; ">
        ...
        <article class="max-w-md p-6 mb-2 bg-slate-200 border border-violet-100 rounded-xl shadow">
          <div class="flex items-center mb-2 space-x-4">
              <img class="w-12 h-12 rounded-full" src="{{ asset('https://book-mamagement-system.vercel.app/avatars/' . $comment->user->avatar . '.png') }}" alt="">
